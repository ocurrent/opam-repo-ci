...
- [b.0.0.7] has opam lint errors/warnings
  ...
  Error in b.0.0.2: Your dune-project file indicates that this package requires at least dune 3.16 but your opam file has no lower bound on its dune dependency. Please check which requirement is the right one, and fix the other.
  [1]
  $ opam-ci-check lint -r . b.0.0.3:new=false
  Linting opam-repository at $TESTCASE_ROOT/. ...
